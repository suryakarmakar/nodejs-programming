...
const parseProductsJsonData = JSON.parse(productsJsonData);

const server = http.createServer((req, res) => {
  // const pathName = req.url;
  // url.parse use for persing the query strings form url, if you pass true in 2nd argument then you get query object
  ...
  if (pathname === '/api/products') {
    // if you have nested folder then use "__dirname/file.name" insted of "./file.name"
